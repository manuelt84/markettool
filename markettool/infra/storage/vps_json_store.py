...
VPS_ONLY_MODES = {"vps", "postgres", "local", "filesystem", "fs", "vps_only", "vps-only", "only_vps", "solo_vps"}
GCP_TO_VPS_MODES = {
    "hybrid",
    "gcp_vps",
    "gcp-vps",
    "gcp_fallback_vps",
    "gcp-fallback-vps",
    "gcp_with_fallback_to_vps",
    "gcp-with-fallback-to-vps",
    "gcp_fallback_to_vps",
    "gcp-fallback-to-vps",
}
VPS_TO_GCP_MODES = {
    ...
    "vps_fallback_gcp",
    "vps-fallback-gcp",
    "vps_with_fallback_to_gcp",
    "vps-with-fallback-to-gcp",
    "vps_fallback_to_gcp",
    "vps-fallback-to-gcp",
}
